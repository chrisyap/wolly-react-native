...
execSync(
  `icon-font-generator ./src/Assets/Icons/*.svg -o ./src/Assets/Fonts -n shaper-icons -c false --html false --types ttf`
);

// STEP 2: Modify glyph map, change hexa values to decimal
const glyphMap = JSON.parse(
  fs.readFileSync('./src/Assets/Fonts/shaper-icons.json')
);
...
fs.writeFileSync(
  './src/Assets/Fonts/shaper-icons.json',
  JSON.stringify(glyphMapDecimal)
); // write file
