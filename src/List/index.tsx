...
import { Animated, FlatListProps, LayoutChangeEvent, StyleSheet } from 'react-native';
import styled from 'styled-components/native';
import { composed } from '../Common/Composed';
import V from '../View';
import Scrollbar from '../Common/Scrollbar';

const StyledList = styled(Animated.FlatList as new () => Animated.FlatList<any>)`
  ${composed};
`;
...
class List extends React.Component<ListProps & FlatListProps<any>, State> {
  constructor(props: ListProps & FlatListProps<any>) {
    super(props);
    this.state = {
  ...
  render(): React.ReactNode {
    ...
    const { data, doNotGrow, ...props } = this.props;
